# Generated by Django 2.0.9 on 2022-03-14 15:16
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_client', models.BooleanField(default=True, help_text='Helps to easily distinguish clients from staff in queries. Clients are the main type of user.', verbose_name='client')),
                ('is_verified', models.BooleanField(default=False, help_text='Set to True when the user has verified his email address.', verbose_name='verified')),
